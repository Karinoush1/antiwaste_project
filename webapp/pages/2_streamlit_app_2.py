...
def main():
    ...
    if selected == liste_menu[3]:
        ...
        with col3:
            ...
            col6.image("tableau_d_emission.jpg", caption='Ces catégories ne sont pas des chiffres officiels. Ils ne peuvent en aucun cas être utilisés comme référence.')
        ...
        with col4:
            ...
            with st.expander("⏯️ Prévention anti-gaspillage"):
